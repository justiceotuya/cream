import 'package:cream_platform_app/apis/biditem/id/repository/get_or_delete_bid_repository.dart';
...
class GetAllBidEntryStatisticsProviders extends ChangeNotifier {
  ...
  void getOrDeleteBid({@required int id, bool isItDeleteRequest}) async {
    try {
      _progressIndicator.show();
      final _response = await _repository.getOrDeleteID(
          id: id, isItDeleteRequest: isItDeleteRequest);
